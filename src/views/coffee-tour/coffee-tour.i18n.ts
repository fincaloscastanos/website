...
export const translations = {
  ...
  intro: {
    p1: {
      de: "Erleben Sie die Welt des Kaffees! Unser Tourguide zeigt Ihnen in etwa einer Stunde unsere Plantage und Hänge mit den angebauten Pflanzen und gibt auf Spanisch, Französisch, Englisch, Deutsch oder Russisch ihr spannendes Wissen rund um Anbau und Kaffeegenuss weiter.",
      en: "Experience the world of coffee! Our tour guide will show you our plantation and slopes with the cultivated plants in about an hour and pass on her exciting knowledge about cultivation and coffee enjoyment in Spanish, French, English, German or Russian.",
      es: "¡Vengan a conocer el mundo del café! Nuestra guía les enseña la plantación y las laderas con los cultivos durante una horita, contándoles todo lo que sabe sobre el cultivo y el buen café – en español, francés, inglés, alemán o ruso.",
    },
    p2: {
  ...
  faq: {
    ...
    items: {
      de: [
        ...
        { question: "In welchen Sprachen wird die Tour angeboten?", answer: "Die Tour wird auf Spanisch, Englisch, Französisch, Deutsch und Russisch angeboten." },
        { question: "Muss ich die Tour im Voraus buchen?", answer: "Eine Online-Buchung wird empfohlen, da die Plätze begrenzt sind." },
        { question: "Ist die Tour für Kinder geeignet?", answer: "Ja, Kinder sind willkommen. Wir bieten au\u00dferdem Ausfl\u00fcge und Workshops f\u00fcr Schulklassen an." },
        { question: "Was ist im Tourpreis enthalten?", answer: "Der Preis beinhaltet die geführte Besichtigung der Kaffeeplantage, Erklärungen zum Kaffeeanbau und eine Kaffeeverkostung. Bei der Verkostung servieren wir frisch gemahlenen Kaffee, ein Glas Weißwein oder Saft aus der Region, Wasser, lokalen Käse, eine Auswahl regionaler Marmeladen sowie hausgemachte Kekse und Kuchen." },
      ...
      en: [
        ...
        { question: "What languages are the tours offered in?", answer: "Tours are offered in Spanish, English, French, German, and Russian." },
        { question: "Do I need to book in advance?", answer: "Advance online booking is recommended as places are limited." },
        { question: "Is the tour suitable for children?", answer: "Yes, children are welcome. We also offer excursions and workshops for school groups." },
        { question: "What is included in the tour price?", answer: "The price includes a guided visit of the coffee plantation, explanations about coffee cultivation, and a coffee tasting session. During the tasting we serve freshly ground coffee, a glass of white wine or local juice, water, local cheese, a selection of regional jams, and homemade biscuits and cakes." },
      ...
      es: [
        ...
        { question: "\u00bfEn qu\u00e9 idiomas se ofrece el tour?", answer: "Los tours se ofrecen en espa\u00f1ol, ingl\u00e9s, franc\u00e9s, alem\u00e1n y ruso." },
        { question: "\u00bfEs necesario reservar con antelaci\u00f3n?", answer: "Se recomienda reservar online ya que las plazas son limitadas." },
        { question: "\u00bfEl tour es apto para ni\u00f1os?", answer: "S\u00ed, los ni\u00f1os son bienvenidos. Ofrecemos excursiones y talleres para grupos escolares." },
        { question: "\u00bfQu\u00e9 incluye el precio del tour?", answer: "El precio incluye una visita guiada por la plantaci\u00f3n de caf\u00e9, explicaciones sobre el cultivo del caf\u00e9 y una degustaci\u00f3n. Durante la degustaci\u00f3n ofrecemos caf\u00e9 reci\u00e9n molido, una copa de vino blanco o zumo de la zona, agua, queso local, una selecci\u00f3n de mermeladas locales, galletas y bizcochos caseros." },
  ...
  pricing: {
    ...
    children: {
      de: `Kinder ${coffeeTour.childrenMinAge}–${coffeeTour.childrenMaxAge} Jahre`,
      en: `Children ${coffeeTour.childrenMinAge}–${coffeeTour.childrenMaxAge} years`,
      es: `Niños ${coffeeTour.childrenMinAge}–${coffeeTour.childrenMaxAge} años`,
    },
    infants: {
      de: `Kleinkinder ${coffeeTour.infantsMinAge}–${coffeeTour.infantsMaxAge} Jahre`,
      en: `Infants ${coffeeTour.infantsMinAge}–${coffeeTour.infantsMaxAge} years`,
      es: `Peques ${coffeeTour.infantsMinAge}–${coffeeTour.infantsMaxAge} años`,
    },
    infantsFree: {
      de: "kostenlos",
      en: "free of charge",
    ...
    adultsPrice: {
      de: fp(coffeeTour.adults),
      en: fp(coffeeTour.adults),
      es: fp(coffeeTour.adults),
    },
    childrenPrice: {
      de: fp(coffeeTour.children),
      en: fp(coffeeTour.children),
      es: fp(coffeeTour.children),
    },
    duration: {
