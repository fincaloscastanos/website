...
export const translations = {
  ...
  seo: {
    ...
    description: {
      de: "Allgemeine Geschäftsbedingungen der Finca Los Castaños – Kaffeetouren, Verkostungen und Unterkünfte in Agaete, Gran Canaria",
      en: "General terms and conditions of Finca Los Castaños – coffee tours, tastings and accommodation in Agaete, Gran Canaria",
      es: "Condiciones generales de Finca Los Castaños – tours de café, degustaciones y alojamiento en Agaete, Gran Canaria",
    },
  },
  ...
  accommodation: {
    heading: {
      de: "3. Vermietung der Unterkünfte",
      en: "3. Accommodation Rental",
      es: "3. Alquiler de alojamientos",
    },
    reservationTitle: {
      de: "3.1 Reservierung und Anzahlung",
      en: "3.1 Reservation and Deposit",
      es: "3.1 Reserva y anticipo",
    },
    reservationText: {
      de: "Eine Reservierung der Unterkunft wird erst durch eine Anzahlung in Höhe von 25 % des Gesamtpreises verbindlich. Der Restbetrag wird automatisch 14 Tage vor Anreise über das hinterlegte Zahlungsmittel eingezogen. Der Gast muss bei Check-in ein gültiges Ausweisdokument zur polizeilichen Registrierung vorlegen.",
      en: "A reservation for the accommodation only becomes binding upon payment of a deposit of 25% of the total price. The remaining amount will be automatically charged to the payment method on file 14 days before arrival. The guest must present a valid identity document for police registration at check-in.",
      es: "La reserva del alojamiento solo será vinculante tras el pago de un anticipo del 25 % del precio total. El importe restante se cobrará automáticamente 14 días antes de la llegada a través del medio de pago registrado. El huésped deberá presentar un documento de identidad válido para el registro policial en el momento del check-in.",
    },
    checkinTitle: {
      de: "3.2 Check-in und Check-out",
      en: "3.2 Check-in and Check-out",
      es: "3.2 Check-in y check-out",
    },
    checkinText: {
      de: "Check-in ab 15:00 Uhr. Check-out bis 11:00 Uhr. Abweichende Zeiten nach vorheriger Absprache möglich.",
      en: "Check-in from 3:00 PM. Check-out by 11:00 AM. Different times possible by prior arrangement.",
      es: "Check-in a partir de las 15:00 h. Check-out hasta las 11:00 h. Horarios diferentes posibles previa consulta.",
    },
    cancellationTitle: {
      de: "3.3 Stornierung der Unterkunft",
      en: "3.3 Accommodation Cancellation",
      es: "3.3 Cancelación del alojamiento",
    },
    cancellation1: {
      de: "Bis 30 Tage vor Anreise: 75 % des Gesamtpreises werden erstattet.",
      en: "Up to 30 days before arrival: 75% of the total price will be refunded.",
      es: "Hasta 30 días antes de la llegada: se reembolsará el 75 % del precio total.",
    },
    cancellation2: {
      de: "29 bis 14 Tage vor Anreise: Einbehalt von 75 % des Gesamtpreises.",
      en: "29 to 14 days before arrival: 75% of the total price will be retained.",
      es: "De 29 a 14 días antes de la llegada: se retendrá el 75 % del precio total.",
    },
    cancellation3: {
      de: "Weniger als 14 Tage vor Anreise oder Nichtanreise: 100 % des Gesamtpreises werden fällig.",
      en: "Less than 14 days before arrival or no-show: 100% of the total price is due.",
      es: "Menos de 14 días antes de la llegada o no presentación: se adeuda el 100 % del precio total.",
    },
    cancellation4: {
      de: "Non-Refundable Tarife sehen keine Erstattung bei Stornierung vor.",
      en: "Non-refundable rates do not provide for any refund in case of cancellation.",
    ...
    thirdPartyTitle: {
      de: "3.4 Abweichende Konditionen bei Buchung über Drittplattformen",
      en: "3.4 Deviating Conditions for Bookings via Third-Party Platforms",
      es: "3.4 Condiciones diferentes para reservas a través de plataformas de terceros",
    },
    thirdPartyText: {
      de: "Bei Buchungen über externe Plattformen (z. B. Smoobu-Direktbuchung, Bokun, Booking.com) können abweichende Zahlungs-, Stornierungs- und Erstattungsbedingungen gelten. In diesem Fall haben die Bedingungen der jeweiligen Plattform zum Zeitpunkt der Buchung Vorrang vor den in diesen AGB genannten Konditionen. Der Gast wird gebeten, die plattformspezifischen Bedingungen vor Abschluss der Buchung zu prüfen.",
      en: "For bookings made through external platforms (e.g. Smoobu direct booking, Bokun, Booking.com), different payment, cancellation and refund conditions may apply. In such cases, the conditions of the respective platform at the time of booking take precedence over the conditions stated in these Terms. The guest is asked to review the platform-specific conditions before completing the booking.",
      es: "Para las reservas realizadas a través de plataformas externas (p. ej., reserva directa de Smoobu, Bokun, Booking.com), pueden aplicarse condiciones de pago, cancelación y reembolso diferentes. En tal caso, las condiciones de la plataforma correspondiente en el momento de la reserva prevalecen sobre las condiciones establecidas en estas condiciones generales. Se ruega al huésped que revise las condiciones específicas de la plataforma antes de completar la reserva.",
    },
  },

  finca: {
    heading: {
      de: "4. Allgemeine Bestimmungen für die Finca",
      en: "4. General Provisions for the Finca",
      es: "4. Disposiciones generales para la finca",
    },
    safetyTitle: {
      de: "4.1 Sicherheit und Kleidung",
      en: "4.1 Safety and Clothing",
      es: "4.1 Seguridad y vestimenta",
    },
    safetyText: {
    ...
    liabilityTitle: {
      de: "4.2 Haftungsausschluss",
      en: "4.2 Disclaimer of Liability",
      es: "4.2 Exclusión de responsabilidad",
    },
    liabilityText: {
    ...
    finalTitle: {
      de: "4.5 Schlussbestimmungen",
      en: "4.5 Final Provisions",
      es: "4.5 Disposiciones finales",
    },
    finalText: {
